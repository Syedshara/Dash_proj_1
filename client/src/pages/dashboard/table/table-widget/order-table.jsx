...
export const OrdersTable = () => {
    ...
    const { data, loading, error } = ordersTableData(ordersPage, rowsPerPage);
                    ...
                    <>
                        <div className="overflow-y-auto" style={{ maxHeight: "300px" }}>
                            <table className="w-full min-w-[640px] table-auto">
                                ...
                                <tbody>
                                    {sortedOrders.map(({ id, name, address, price, status }) => (
                                        <tr key={id}>
                        ...
                        <div className="flex justify-between items-center mt-4 px-4">
                            ...
                            <div className="text-sm font-medium text-blue-gray-600">
                                Page {ordersPage} of {totalPages} ||  Total Records: {totalRecords}
                            </div>
